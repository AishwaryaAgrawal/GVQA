...
cmd:option('-input_h5_vcc_test', '/srv/share/aagrawal307/compositionality/vqa/vqa_compositionality/to_release/predictions/vcc_results.h5', 'path to vcc predictions')
