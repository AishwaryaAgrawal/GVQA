...
cmd:option('-input_question_classifier_output', '/srv/share/aagrawal307/compositionality/vqa/vqa_compositionality/to_release/predictions/question_classifier_results.h5', 'path to yes no classifier output')
